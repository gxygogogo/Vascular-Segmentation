...
#%% DAPI通道生成组织轮廓
# ——— 参数 ———
sample_name = 'CGL_11_CD31_555_ELOVL5_647_FFPE_2025_06_30_1862'
img_path    = f'/public5/3D-TME/1.IF/1.raw_czi/{sample_name}.czi'
save_dir    = f'/public3/Xinyu/3D_tissue/IF/Vascular_IF/MultiClassification_model/multiHead/twoChannel/{sample_name}'
...
cv2.imwrite(f'{save_dir}/tissue_contours.png', image_copy)
...
vessel_pred_path    = f"/public3/Xinyu/3D_tissue/IF/Vascular_IF/MultiClassification_model/multiHead/twoChannel/{sample_name}/{sample_name}_small_vessel_pred.png"   # 预测出的二值血管掩码（0/255）
out_filtered        = f"/public3/Xinyu/3D_tissue/IF/Vascular_IF/MultiClassification_model/multiHead/twoChannel/{sample_name}/{sample_name}_small_step1_filtered.png"
out_connected       = f"/public3/Xinyu/3D_tissue/IF/Vascular_IF/MultiClassification_model/multiHead/twoChannel/{sample_name}/{sample_name}_small_step2_connected.png"
out_filled          = f"/public3/Xinyu/3D_tissue/IF/Vascular_IF/MultiClassification_model/multiHead/twoChannel/{sample_name}/{sample_name}_small_step3_filled.png"
