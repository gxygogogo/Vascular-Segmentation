...
sample_names  = ['CGL_14_CD31_555_ELOVL5_647_FFPE_2025_06_23_1718',
                 'LJM_14_CD31_555_ELOVL5_647_R_eliminator_FFPE_2025_06_20_1707',
                 'LJM_14_CD31_555_FFPE_2025_06_20_1707.dapi',
                 'LSN_4_15_CD31_555_ELOVL5_647_FFPE_2025_06_23_1717',
                 'CGL_11_CD31_555_ELOVL5_647_FFPE_2025_06_30_1862',
                 'HLX_22_NORMAL_CD31_555_ELOVL5_647_FFPE_2025_06_30__1859',
                 'HLX_2_1_6_CD31_555_ELOVL5_647_FFPE_2025_06_30_1858',
                 'HYS_1_13_CD31_555_ELOVL5_647_FFPE_2025_06_30_1856',
                 'HYS_2_13_NORMAL_CD31_555_ELOVL5_647_FFPE_2025_06_30__1857',
                 'YP_1_14_CD31_555_ELOVL5_647_FFPE_2025_06_30_1860',
                 'YP_3_13_NORMAL_CD31_555_ELOVL5_647_FFPE_2025_06_30_1861',
                 'LPN_2_1_CD31_555_ELOVL5_647_DESI_FROZEN_2025_07_02_1981',]
for sample_name in sample_names:
    ...
    output_dir   = f'/public3/Xinyu/3D_tissue/IF/Vascular_IF/MultiClassification_model/multiHead/twoChannel/{sample_name}'
    patch_size   = 256
    overlap_frac = 0.75
    ...
    cd31_raw = raw[2].astype(np.float32)

    # 归一化到 [0,1]
    dapi = cv2.normalize(dapi_raw, None, 0,1, cv2.NORM_MINMAX)
    cd31 = cv2.normalize(cd31_raw, None,0,1, cv2.NORM_MINMAX)
    ...
    # —— 投票融合 —— #
    mask_large = ((sum_large/cnt) > 0.3).astype(np.uint8)*255
