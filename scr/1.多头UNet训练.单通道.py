...
train_dir = "/public3/Xinyu/3D_tissue/IF/Vascular_IF/MultiClassification_model/Version_256/train"
save_dir="/public3/Xinyu/3D_tissue/IF/Vascular_IF/MultiClassification_model/multiHead"
...
lr = 1e-4
batch_size = 1
ds = TwoHeadDataset(train_dir)
n_val = int(len(ds)*0.1); n_train=len(ds)-n_val
